			...
			<table class="table">
				<tbody>
					...
					<tr>
						...
						<td>
							<input type="text" name="pstd" id="pstd" title="100자 내로 작성" placeholder="100자 내로 작성" class="form-control">
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							<input type="number" name="amount" id="amount" value="1" min="0" max="500" title="1~500" class="form-control">
						</td>
					</tr>
					<tr>
