...
<div class="content" style="padding-top:30px; margin-top:30px; border-top:3px solid #333; min-height:500px; ">
	<div class="container-fluid">
		...
		<c:if test="${sid.equals('admin') }">
			<div class="btn-group">
				<a href="${path1 }/AdminCateProductList.do?cate=01" role="button" class="btn btn-primary">운동화 </a>
				<a href="${path1 }/AdminCateProductList.do?cate=02" role="button" class="btn btn-primary">슬리퍼 </a>
				<a href="${path1 }/AdminCateProductList.do?cate=03" role="button" class="btn btn-primary">구두 </a>
				<a href="${path1 }/AdminCateProductList.do?cate=04" role="button" class="btn btn-primary">국내 일반 도서 </a>
				<a href="${path1 }/AdminCateProductList.do?cate=05" role="button" class="btn btn-primary">기타 서적 </a>
