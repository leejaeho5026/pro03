...
public class ProductDAO {
	...
	public Product getProduct(String pcode){
		...
		try {
			...
			if(rs.next()){
				...
				pro.setUtburl(rs.getString("utburl"));
				pro.setBookidx(rs.getString("bookidx"));
	...
	public int insertProduct(Product pro) {
		...
		try {
			...
			pstmt.setString(10, pro.getUtburl());
			pstmt.setString(11, pro.getBookidx());
			pstmt.setString(12, pro.getCate());
	...
	public int updateProduct(Product pro) {
		...
		try {
			...
			pstmt.setString(9, pro.getUtburl());
			pstmt.setString(10, pro.getBookidx());
